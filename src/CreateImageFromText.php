...
namespace Hracik\CreateImageFromText;
...
class CreateImageFromText
{
	 ...
	 * @throws Exception
	 */
	public static function createImageFromText(string $text_string, int $text_angle = 0, int $text_padding = 10, int $font_size = 12, ?string $font_ttf = null, int $returnType = self::RETURN_BASE64)
	{
		if ($font_ttf === null) {
			$font_ttf = dirname(__FILE__) .'/fonts/arial.ttf';
		}
